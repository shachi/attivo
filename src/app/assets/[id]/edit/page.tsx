  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (!assetRes.ok) throw new Error("資産データの取得に失敗しました");
        ...
        setFormData({
          ...
          warrantyExpiryDate: assetData.warrantyExpiryDate
            ? new Date(assetData.warrantyExpiryDate).toISOString().split("T")[0]
            : "",
          renewalDate: assetData.renewalDate
            ? new Date(assetData.renewalDate).toISOString().split("T")[0]
            : "",
          purchasePrice: assetData.purchasePrice
            ? String(assetData.purchasePrice)
            : "",
          currency: assetData.currency || "JPY",
          purchasedById: assetData.purchasedById || "",
          currentUserId: assetData.currentUserId || "",
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        <div className="mb-6 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900">資産編集</h1>
          </div>
